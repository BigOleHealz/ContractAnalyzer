...
type SchemaType = z.ZodType<Prisma.PushNotificationUpdateManyMutationInput>;
export const PushNotificationUpdateManyMutationInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
