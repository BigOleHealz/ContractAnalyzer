...
export const UserUncheckedUpdateWithoutSessionsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
    ...
    z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(), accounts: z.lazy(() => AccountUncheckedUpdateManyWithoutUserNestedInputObjectSchema).optional(), pushNotifications: z.lazy(() => PushNotificationUncheckedUpdateManyWithoutUserNestedInputObjectSchema).optional(), contracts: z.lazy(() => ContractUncheckedUpdateManyWithoutUserNestedInputObjectSchema).optional()
