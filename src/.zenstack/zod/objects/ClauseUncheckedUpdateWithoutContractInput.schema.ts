...
type SchemaType = z.ZodType<Prisma.ClauseUncheckedUpdateWithoutContractInput>;
export const ClauseUncheckedUpdateWithoutContractInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
