...
type SchemaType = z.ZodType<Prisma.PushNotificationUncheckedUpdateManyWithoutUserInput>;
export const PushNotificationUncheckedUpdateManyWithoutUserInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
