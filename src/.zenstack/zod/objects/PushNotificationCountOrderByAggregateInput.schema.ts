...
type SchemaType = z.ZodType<Prisma.PushNotificationCountOrderByAggregateInput>;
export const PushNotificationCountOrderByAggregateInputObjectSchema: SchemaType = z.object({
