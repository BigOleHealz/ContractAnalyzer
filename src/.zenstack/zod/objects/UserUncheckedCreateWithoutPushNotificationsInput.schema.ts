...
type SchemaType = z.ZodType<Prisma.UserUncheckedCreateWithoutPushNotificationsInput>;
export const UserUncheckedCreateWithoutPushNotificationsInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), dateCreated: z.union([z.date().optional(), z.string().datetime().optional()]), dateUpdated: z.union([z.date().optional(), z.string().datetime().optional()]), accounts: z.lazy(() => AccountUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional(), sessions: z.lazy(() => SessionUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional(), contracts: z.lazy(() => ContractUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional()
