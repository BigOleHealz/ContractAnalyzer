...
type SchemaType = z.ZodType<Prisma.ContractUncheckedUpdateWithoutClausesInput>;
export const ContractUncheckedUpdateWithoutClausesInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
