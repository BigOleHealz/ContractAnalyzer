...
import { ClauseUpdateManyWithoutContractNestedInputObjectSchema } from './ClauseUpdateManyWithoutContractNestedInput.schema';

import type { Prisma } from '@prisma/client';

type SchemaType = z.ZodType<Prisma.ContractUpdateInput>;
export const ContractUpdateInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
    ...
    z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(), user: z.lazy(() => UserUpdateOneWithoutContractsNestedInputObjectSchema).optional(), clauses: z.lazy(() => ClauseUpdateManyWithoutContractNestedInputObjectSchema).optional()
