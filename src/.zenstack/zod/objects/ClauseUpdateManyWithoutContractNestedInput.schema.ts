...
type SchemaType = z.ZodType<Prisma.ClauseUpdateManyWithoutContractNestedInput>;
export const ClauseUpdateManyWithoutContractNestedInputObjectSchema: SchemaType = z.object({
