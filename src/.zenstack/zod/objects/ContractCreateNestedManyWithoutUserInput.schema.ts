...
type SchemaType = z.ZodType<Prisma.ContractCreateNestedManyWithoutUserInput>;
export const ContractCreateNestedManyWithoutUserInputObjectSchema: SchemaType = z.object({
