...
type SchemaType = z.ZodType<Prisma.UserUncheckedCreateWithoutContractsInput>;
export const UserUncheckedCreateWithoutContractsInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), dateCreated: z.union([z.date().optional(), z.string().datetime().optional()]), dateUpdated: z.union([z.date().optional(), z.string().datetime().optional()]), accounts: z.lazy(() => AccountUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional(), sessions: z.lazy(() => SessionUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional(), pushNotifications: z.lazy(() => PushNotificationUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional()
