...
type SchemaType = z.ZodType<Prisma.UserUpdateWithoutPushNotificationsInput>;
export const UserUpdateWithoutPushNotificationsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
    ...
    z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(), accounts: z.lazy(() => AccountUpdateManyWithoutUserNestedInputObjectSchema).optional(), sessions: z.lazy(() => SessionUpdateManyWithoutUserNestedInputObjectSchema).optional(), contracts: z.lazy(() => ContractUpdateManyWithoutUserNestedInputObjectSchema).optional()
