...
type SchemaType = z.ZodType<Prisma.ClauseUncheckedUpdateManyInput>;
export const ClauseUncheckedUpdateManyInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
    ...
    z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema),
    z.null()]).optional().nullable(), contractId: z.union([z.string(),
