...
type SchemaType = z.ZodType<Prisma.UserUpdateWithoutContractsInput>;
export const UserUpdateWithoutContractsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
    ...
    z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(), accounts: z.lazy(() => AccountUpdateManyWithoutUserNestedInputObjectSchema).optional(), sessions: z.lazy(() => SessionUpdateManyWithoutUserNestedInputObjectSchema).optional(), pushNotifications: z.lazy(() => PushNotificationUpdateManyWithoutUserNestedInputObjectSchema).optional()
