...
type SchemaType = z.ZodType<Prisma.ClauseUncheckedUpdateManyWithoutContractInput>;
export const ClauseUncheckedUpdateManyWithoutContractInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
