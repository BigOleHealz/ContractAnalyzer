...
export const UserUncheckedUpdateWithoutAccountsInputObjectSchema: SchemaType = z.object({
    ...
    z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(), sessions: z.lazy(() => SessionUncheckedUpdateManyWithoutUserNestedInputObjectSchema).optional(), pushNotifications: z.lazy(() => PushNotificationUncheckedUpdateManyWithoutUserNestedInputObjectSchema).optional(), contracts: z.lazy(() => ContractUncheckedUpdateManyWithoutUserNestedInputObjectSchema).optional()
