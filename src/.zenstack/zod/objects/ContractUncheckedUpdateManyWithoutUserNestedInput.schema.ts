...
type SchemaType = z.ZodType<Prisma.ContractUncheckedUpdateManyWithoutUserNestedInput>;
export const ContractUncheckedUpdateManyWithoutUserNestedInputObjectSchema: SchemaType = z.object({
