...
type SchemaType = z.ZodType<Prisma.PushNotificationUncheckedUpdateWithoutUserInput>;
export const PushNotificationUncheckedUpdateWithoutUserInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
