...
type SchemaType = z.ZodType<Prisma.ContractUncheckedUpdateManyWithoutUserInput>;
export const ContractUncheckedUpdateManyWithoutUserInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
