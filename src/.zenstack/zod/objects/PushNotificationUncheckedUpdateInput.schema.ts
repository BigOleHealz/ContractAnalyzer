...
type SchemaType = z.ZodType<Prisma.PushNotificationUncheckedUpdateInput>;
export const PushNotificationUncheckedUpdateInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
